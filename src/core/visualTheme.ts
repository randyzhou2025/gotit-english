...
const MORNING_MINT_THEME: VisualTheme = {
  ...
  tokens: {
    ...
    '--accent-soft': '#d5ebe2',
    '--calendar-level-1': '#dcebe4',
    '--calendar-level-2': '#a9ccb8',
    '--calendar-level-3': '#4f8d6d',
    '--calendar-level-4': '#155744',
...
const CLOUDFIELD_SKY_THEME: VisualTheme = {
  ...
  tokens: {
    ...
    '--accent-soft': '#dcebf2',
    '--calendar-level-1': '#dcebf2',
    '--calendar-level-2': '#b5cedb',
    '--calendar-level-3': '#527f9d',
    '--calendar-level-4': '#365f7b',
...
const INK_PEARL_THEME: VisualTheme = {
  ...
  tokens: {
    ...
    '--accent-soft': '#e9e9e6',
    '--calendar-level-1': '#e9e9e6',
    '--calendar-level-2': '#c9c9c3',
    '--calendar-level-3': '#6d6d68',
    '--calendar-level-4': '#050505',
    '--danger': '#181818',
