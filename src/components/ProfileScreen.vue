...
async function generateScorePoster() {
  ...
  try {
    ...
    context.fillText(`“${selectedQuote.quote.lines[0]}`, 64, 150)
    context.fillText(`${selectedQuote.quote.lines[1]}”`, 64, 218)
    context.setStrokeStyle('#8fb5a6')
    context.setLineWidth(2)
    context.beginPath()
    context.moveTo(66, 281)
    context.lineTo(98, 281)
    context.stroke()
    context.setFillStyle('#4f7468')
    context.setFontSize(23)
    context.fillText(selectedQuote.quote.author, 116, 290)
    ...
    shareContext.fillText(`“${selectedQuote.quote.lines[0]}`, 54, 102)
    shareContext.fillText(`${selectedQuote.quote.lines[1]}”`, 54, 156)
    shareContext.setStrokeStyle('#8fb5a6')
    shareContext.setLineWidth(2)
    shareContext.beginPath()
    shareContext.moveTo(56, 210)
    shareContext.lineTo(84, 210)
    shareContext.stroke()
    shareContext.setFillStyle('#4f7468')
    shareContext.setFontSize(21)
    shareContext.fillText(selectedQuote.quote.author, 100, 218)
